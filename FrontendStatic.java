...
class Frontend{
	...
	public static List<String> allGenres; //Track genres available
	public static List<String> selectedGenres; //Track selected genres
	public static int selectionScroll; //Index entry to scroll through returned movies (since only 3 are displayed at a time)

	public static boolean[] selectedRatings; //Track selected ratings

	public static boolean testing = false; //Used to not clear the screen when testing
	...
	public static void isTesting(boolean is){
		testing = is;
	}
	...
	public static void baseMode(String in){ 
	...
	public static void genreMode(String in){
	...
	public static void ratingMode(String in){
		if(in.charAt(0) == 'x'){
			mode = Mode.base;
			return;
		}
